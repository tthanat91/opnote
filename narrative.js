    ...
    steps: [
      {
        ...
        lines: [
          ...
          { group: 'ima', needs: ['cr_vascular'], equals: 'High tie',
          ...
          { group: 'ima', needs: ['cr_vascular'], equals: 'Low tie',
          ...
          { group: 'imv', needs: ['cr_l_imv'], equals: 'Preserved',
            text: 'The inferior mesenteric vein was preserved.' },
          { group: 'imv', needs: ['cr_l_imv'],
            text: 'The inferior mesenteric vein was {cr_l_imv|lc}.' },
          ...
          { group: 'trans', needs: ['cr_l_firings', 'cr_l_transection', 'cr_l_transection_size', 'cr_l_transection_color'], equals: '1',
            text: 'The rectum was divided distally with a single firing of {cr_l_transection} {cr_l_transection_size}, {cr_l_transection_color|lc} cartridge, at right angles to the bowel.' },
          { group: 'trans', needs: ['cr_l_firings', 'cr_l_transection', 'cr_l_transection_size', 'cr_l_transection_color'],
            text: 'The rectum was divided distally with {cr_l_firings} firings of {cr_l_transection} {cr_l_transection_size}, {cr_l_transection_color|lc} cartridge, at right angles to the bowel.' },
          { group: 'trans', needs: ['cr_l_firings', 'cr_l_transection'], equals: '1',
            text: 'The rectum was divided distally with a single firing of {cr_l_transection}, at right angles to the bowel.' },
          { group: 'trans', needs: ['cr_l_firings', 'cr_l_transection'],
            text: 'The rectum was divided distally with {cr_l_firings} firings of {cr_l_transection}, at right angles to the bowel.' },
          { group: 'trans', needs: ['cr_l_transection'],
            text: 'The rectum was divided distally with «one firing of» {cr_l_transection}.' },
