...
(function (global) {
  ...
  global.TEMPLATES_BUILD = '2026-08-02ch';
  ...
  global.DEFAULT_TEMPLATES = [
    ...
    f('stoma', 'การเข้าถึง | Approach', 'st_approach',
      'วิธีการผ่าตัด', 'Approach', 'radio', 'Open; Laparoscopic; Laparoscopic converted to open; Robotic'),
    f('stoma', 'การเข้าถึง | Approach', 'st_position',
      'ท่าผู้ป่วย', 'Patient position', 'radio', 'Supine; Modified lithotomy (Lloyd-Davies); Right lateral; Left lateral'),
    f('stoma', 'การเข้าถึง | Approach', 'st_incision',
      'แผลผ่าตัด', 'Incision', 'textarea', '',
      'st_approach = Open; Laparoscopic converted to open; Robotic'),
    f('stoma', 'หัตถการ | Procedure', 'st_procedure',
      'การผ่าตัดที่ทำ', 'Procedure performed', 'radio', 'Loop ileostomy; Loop colostomy; End colostomy; End ileostomy; Stoma closure; Reversal of Hartmann'),
    ...
    f('stoma', 'สิ่งตรวจพบ | Operative findings', 'st_type',
      ...
      'st_procedure = Stoma closure; Reversal of Hartmann'),
    ...
    f('stoma', 'สิ่งตรวจพบ | Operative findings', 'st_stump',
      ...
      'st_procedure = Reversal of Hartmann'),
    ...
    f('stoma', 'การต่อลำไส้ | Anastomosis', 'st_method',
      ...
      'st_procedure = Stoma closure; Reversal of Hartmann'),
    f('stoma', 'การต่อลำไส้ | Anastomosis', 'st_hs_config',
    ...
    f('stoma', 'ปิดแผลและท่อระบาย | Closure', 'st_wound',
      'การปิดแผลทวารเทียม', 'Stoma-site wound closure', 'radio', 'Primary; Purse-string; Left open to heal by secondary intention',
      'st_procedure = Stoma closure; Reversal of Hartmann'),
    ...
    f('stoma', 'ปิดแผลและท่อระบาย | Closure', 'st_drain',
      'ท่อระบายในช่องท้อง', 'Intra-abdominal drain', 'text', ''),
    f('stoma', 'ปิดแผลและท่อระบาย | Closure', 'st_drain_site',
      'ตำแหน่งท่อระบาย', 'Drain site', 'radio', 'None; Cul-de-sac (pelvis); Adjacent to the anastomosis; Right paracolic gutter; Left paracolic gutter; Other'),
    ...
    f('stoma', 'ปิดแผลและท่อระบาย | Closure', 'st_drain_sc_type',
      ...
      'st_drain_sc = Yes'),
    f('stoma', 'ปิดแผลและท่อระบาย | Closure', 'st_closure_sheath_material',
      'ไหมเย็บชั้นพังผืด', 'Fascia suture', 'text', ''),
    f('stoma', 'ปิดแผลและท่อระบาย | Closure', 'st_closure_sheath_fashion',
      'ลักษณะการเย็บพังผืด', 'Fascia closure', 'radio', 'Continuous; Interrupted; Mass closure'),
    f('stoma', 'ปิดแผลและท่อระบาย | Closure', 'st_closure_skin_material',
      'ไหมเย็บผิวหนัง', 'Skin suture', 'text', ''),
    f('stoma', 'ปิดแผลและท่อระบาย | Closure', 'st_closure_skin_fashion',
      'ลักษณะการเย็บผิวหนัง', 'Skin closure', 'radio', 'Subcuticular continuous; Interrupted; Staples; Purse-string'),
