...
(function (global) {
  ...
  global.TEMPLATES_BUILD = '2026-08-02cf';
  ...
  global.DEFAULT_TEMPLATES = [
    ...
    f('colorectal', 'มะเร็งวิทยา | Oncological detail', 'cr_splenic_flexure', 'mobilize splenic flexure', 'Splenic flexure mobilization', 'radio',
      ...
      'cr_procedure = Right hemicolectomy; Extended right hemicolectomy; Transverse colectomy; Left hemicolectomy; Sigmoidectomy; Anterior resection; Low anterior resection; Ultra-low anterior resection with coloanal anastomosis; Abdominoperineal resection; Hartmann procedure; Reversal of Hartmann; Subtotal colectomy; Total colectomy; Total proctocolectomy; Restorative proctocolectomy with IPAA'),
    ...
    f('colorectal', 'การต่อลำไส้ | Anastomosis', 'cr_diverting', 'ทวารเทียมชั่วคราว', 'Diverting stoma', 'radio',
      ...
      'cr_procedure = Right hemicolectomy; Extended right hemicolectomy; Transverse colectomy; Left hemicolectomy; Sigmoidectomy; Anterior resection; Low anterior resection; Ultra-low anterior resection with coloanal anastomosis; Subtotal colectomy; Total colectomy; Restorative proctocolectomy with IPAA; Reversal of Hartmann; Stoma closure'),
    ...
    f('colorectal', 'ลำไส้ใหญ่ด้านซ้าย | Left-sided & rectal resection', 'cr_l_leak_method', 'วิธีทดสอบรอยรั่ว', 'Air-leak test method', 'radio',
      'Colonoscopic; Rigid proctoscope; Bulb syringe; Not performed', 'cr_procedure = Left hemicolectomy; Sigmoidectomy; Anterior resection; Low anterior resection; Ultra-low anterior resection with coloanal anastomosis; Subtotal colectomy; Total colectomy; Reversal of Hartmann; Stoma closure'),
    f('colorectal', 'ลำไส้ใหญ่ด้านซ้าย | Left-sided & rectal resection', 'cr_leak_test',
      ...
      'cr_procedure = Left hemicolectomy; Sigmoidectomy; Anterior resection; Low anterior resection; Ultra-low anterior resection with coloanal anastomosis; Subtotal colectomy; Total colectomy; Reversal of Hartmann; Stoma closure'),
    ...
    f('colorectal', 'ทวารเทียม | Stoma formation', 'cr_st_site', 'ตำแหน่งทวารเทียม', 'Stoma site', 'radio',
      ...
      'cr_procedure = Loop ileostomy; Loop colostomy; End colostomy; End ileostomy; Abdominoperineal resection; Hartmann procedure || cr_diverting = Loop ileostomy; Loop colostomy'),
    f('colorectal', 'ทวารเทียม | Stoma formation', 'cr_st_marked', 'ทำเครื่องหมายก่อนผ่าตัด', 'Site marked pre-operatively', 'radio',
      'Yes, by a stoma nurse; Yes, by the surgeon; No', 'cr_procedure = Loop ileostomy; Loop colostomy; End colostomy; End ileostomy; Abdominoperineal resection; Hartmann procedure || cr_diverting = Loop ileostomy; Loop colostomy'),
    f('colorectal', 'ทวารเทียม | Stoma formation', 'cr_st_trephine', 'วิธีเปิดผนังหน้าท้อง', 'Trephine', 'radio',
      'Circular skin disc; Transverse incision', 'cr_procedure = Loop ileostomy; Loop colostomy; End colostomy; End ileostomy; Abdominoperineal resection; Hartmann procedure || cr_diverting = Loop ileostomy; Loop colostomy'),
    ...
    f('colorectal', 'ปิดทวารเทียม | Stoma closure', 'cr_sc_adhesion',
      ...
      'cr_procedure = Stoma closure; Reversal of Hartmann'),
    f('colorectal', 'ปิดทวารเทียม | Stoma closure', 'cr_sc_enterotomy',
      ...
      'cr_procedure = Stoma closure; Reversal of Hartmann'),
    f('colorectal', 'ปิดทวารเทียม | Stoma closure', 'cr_sc_parastomal',
      'ไส้เลื่อนข้างทวารเทียม', 'Parastomal hernia', 'radio', 'None; Present',
      'cr_procedure = Stoma closure; Reversal of Hartmann'),
    f('colorectal', 'ปิดทวารเทียม | Stoma closure', 'cr_sc_parastomal_size',
      'ขนาดคอไส้เลื่อน (ซม.)', 'Hernia defect size (cm)', 'number', '',
      'cr_sc_parastomal = Present'),
    f('colorectal', 'ปิดทวารเทียม | Stoma closure', 'cr_sc_parastomal_repair',
      'วิธีซ่อมไส้เลื่อน', 'Hernia repair', 'radio', 'Primary suture repair; Mesh repair; Not repaired',
      'cr_sc_parastomal = Present'),
    f('colorectal', 'ปิดทวารเทียม | Stoma closure', 'cr_sc_laparotomy',
      'ต้องเปิดหน้าท้องหรือไม่', 'Laparotomy required', 'radio', 'No, circumstomal incision only; Yes, midline laparotomy',
      'cr_procedure = Stoma closure; Reversal of Hartmann'),
    f('colorectal', 'ปิดทวารเทียม | Stoma closure', 'cr_sc_method',
      'วิธีต่อลำไส้', 'Anastomosis method', 'radio', 'Hand-sewn; Stapled',
      'cr_procedure = Stoma closure; Reversal of Hartmann'),
    f('colorectal', 'ปิดทวารเทียม | Stoma closure', 'cr_sc_hs_config',
      'รูปแบบการต่อ (เย็บมือ)', 'Hand-sewn configuration', 'radio', 'End-to-end; Side-to-side',
      'cr_sc_method = Hand-sewn'),
    f('colorectal', 'ปิดทวารเทียม | Stoma closure', 'cr_sc_hs_material',
      'ไหมที่ใช้เย็บต่อ', 'Suture material', 'text', '',
      'cr_sc_method = Hand-sewn'),
    f('colorectal', 'ปิดทวารเทียม | Stoma closure', 'cr_sc_hs_technique',
      'ลักษณะการเย็บ', 'Suture technique', 'radio', 'Interrupted; Continuous',
      'cr_sc_method = Hand-sewn'),
    f('colorectal', 'ปิดทวารเทียม | Stoma closure', 'cr_sc_hs_layers',
      'จำนวนชั้นที่เย็บ', 'Layers', 'radio', 'Single layer; Two layers, with a seromuscular second layer',
      'cr_sc_method = Hand-sewn'),
    f('colorectal', 'ปิดทวารเทียม | Stoma closure', 'cr_sc_st_device',
      'เครื่องเย็บที่ใช้', 'Stapling device', 'radio', 'Linear cutter (GIA); Circular stapler; Linear (TA)',
      'cr_sc_method = Stapled'),
    f('colorectal', 'ปิดทวารเทียม | Stoma closure', 'cr_sc_st_circ_size',
      'ขนาดหัวเครื่องเย็บวงกลม', 'Circular stapler size', 'radio', '25 mm; 28 mm; 29 mm; 31 mm; 33 mm',
      'cr_sc_st_device = Circular stapler'),
    f('colorectal', 'ปิดทวารเทียม | Stoma closure', 'cr_sc_st_gia_len',
      'ความยาวแม็ก', 'Cartridge length', 'radio', '45 mm; 60 mm; 75 mm; 80 mm',
      'cr_sc_st_device = Linear cutter (GIA)'),
    f('colorectal', 'ปิดทวารเทียม | Stoma closure', 'cr_sc_st_gia_colour',
      'สีแม็ก (ความสูงลวด)', 'Cartridge colour (staple height)', 'radio', 'White; Blue; Gold; Green; Purple; Black',
      'cr_sc_st_device = Linear cutter (GIA)'),
    f('colorectal', 'ปิดทวารเทียม | Stoma closure', 'cr_sc_st_firings',
      'จำนวนครั้งที่ยิง', 'Number of firings', 'number', '',
      'cr_sc_st_device = Linear cutter (GIA)'),
    f('colorectal', 'ปิดทวารเทียม | Stoma closure', 'cr_sc_channel',
      'ปิดรูร่วมด้วย', 'Common channel closed by', 'radio', 'Stapled; Hand-sewn',
      'cr_sc_method = Stapled'),
    f('colorectal', 'ปิดทวารเทียม | Stoma closure', 'cr_sc_channel_device',
      'เครื่องเย็บที่ปิดรูร่วม', 'Device used on the common channel', 'radio', 'Linear (TA); Linear cutter (GIA)',
      'cr_sc_channel = Stapled'),
    f('colorectal', 'ปิดทวารเทียม | Stoma closure', 'cr_sc_channel_len',
      'ความยาวแม็กที่ปิดรูร่วม', 'Cartridge length, common channel', 'radio', '45 mm; 60 mm; 75 mm; 80 mm',
      'cr_sc_channel = Stapled'),
    f('colorectal', 'ปิดทวารเทียม | Stoma closure', 'cr_sc_channel_colour',
      'สีแม็กที่ปิดรูร่วม', 'Cartridge colour, common channel', 'radio', 'White; Blue; Gold; Green; Purple; Black',
      'cr_sc_channel = Stapled'),
    f('colorectal', 'ปิดทวารเทียม | Stoma closure', 'cr_sc_channel_material',
      'ไหมที่เย็บปิดรูร่วม', 'Suture material, common channel', 'text', '',
      'cr_sc_channel = Hand-sewn'),
    f('colorectal', 'ปิดทวารเทียม | Stoma closure', 'cr_sc_channel_technique',
      'ลักษณะการเย็บปิดรูร่วม', 'Suture technique, common channel', 'radio', 'Interrupted; Continuous',
      'cr_sc_channel = Hand-sewn'),
    f('colorectal', 'ปิดทวารเทียม | Stoma closure', 'cr_sc_resect',
      'ตัดลำไส้ออกหรือไม่', 'Bowel resected', 'radio', 'No; Yes',
      'cr_procedure = Stoma closure; Reversal of Hartmann'),
    f('colorectal', 'ปิดทวารเทียม | Stoma closure', 'cr_sc_resect_len',
      'ความยาวลำไส้ที่ตัดออก (ซม.)', 'Length of bowel resected (cm)', 'number', '',
      'cr_sc_resect = Yes'),
    f('colorectal', 'ปิดทวารเทียม | Stoma closure', 'cr_sc_wound_material',
      'ไหมที่เย็บปิดแผลทวารเทียม', 'Stoma wound suture', 'text', '',
      'cr_sc_wound = Primary; Purse-string'),
    f('colorectal', 'ปิดทวารเทียม | Stoma closure', 'cr_sc_drain_sc',
      'ท่อระบายใต้ผิวหนัง', 'Subcutaneous drain', 'radio', 'No; Yes',
      'cr_procedure = Stoma closure; Reversal of Hartmann'),
    f('colorectal', 'ปิดทวารเทียม | Stoma closure', 'cr_sc_drain_sc_type',
